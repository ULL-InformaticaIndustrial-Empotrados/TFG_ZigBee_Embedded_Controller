...
bool msn::SurfaceInfo::can_be_active() const
{
    switch (type)
    {
...
bool msn::SurfaceInfo::must_have_parent() const
{
    switch (type)
    {
...
bool msn::SurfaceInfo::can_morph_to(MirSurfaceType new_type) const
{
    switch (new_type)
    {
...
bool msn::SurfaceInfo::must_not_have_parent() const
{
    switch (type)
    {
    case mir_surface_type_normal:
...
bool msn::SurfaceInfo::is_visible() const
{
    switch (state)
    {
...
struct msn::SurfaceInfo::StreamPainter
{
...
struct msn::SurfaceInfo::SwappingPainter
...
void msn::SurfaceInfo::paint_titlebar(int intensity)
{
    stream_painter->paint(intensity);
}

void msn::SurfaceInfo::constrain_resize(
...
bool msn::SurfaceInfo::needs_titlebar(MirSurfaceType type)
{
    switch (type)
    {
    case mir_surface_type_freestyle:
